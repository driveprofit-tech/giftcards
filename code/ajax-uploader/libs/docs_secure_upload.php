...
function secure_upload($options) {
	...
	*/
	...
	$options['image'] = (isset($options['image'])) ? $options['image'] : false; // default true
	...
	foreach($_FILES[$options['field']]['tmp_name'] AS $key => $value) {
		...
		$doc_types = array('txt','doc', 'pdf', 'jpg', 'jpeg', 'png');
		if ($options['image']) {
